        ...
        if ($this->entityData['IS_RECURRING'] !== "Y") {
            if ($this->entityID > 0) {
                ...
                if ($quoteID > 0) {
                    ...
                    // sladcovich custom Работы
                    $this->arResult['TABS'][] = array(
                        'id' => 'tab_sladcovich_work',
                        'name' => 'Работы',
                        'loader' => array(
                            'serviceUrl' => '/local/components/sladcovich/alphaautob24.work/alphaautob24.work.ajax.php?&site' . SITE_ID . '&' . bitrix_sessid_get(),
                            'componentData' => array(
                                'template' => '',
								'params' => array(
									'ENTITY_ID' => array('UF_DEAL_ID' => $this->entityID),
									'TAB_ID' => 'tab_sladcovich_work',
								)
                            )
                        )
                    );

                    // sladcovich custom Работы СК
                    $this->arResult['TABS'][] = array(
                        'id' => 'tab_sladcovich_work_sk',
                        'name' => 'Работы СК',
                        'loader' => array(
                            'serviceUrl' => '/local/components/sladcovich/alphaautob24.worksk/alphaautob24.worksk.ajax.php?&site' . SITE_ID . '&' . bitrix_sessid_get(),
                            'componentData' => array(
                                'template' => '',
								'params' => array(
									'ENTITY_ID' => array('UF_DEAL_ID' => $this->entityID),
									'TAB_ID' => 'tab_sladcovich_work_sk',
								)
                            )
                        )
                    );

                    // sladcovich custom Запчасти
                    $this->arResult['TABS'][] = array(
                        'id' => 'tab_sladcovich_part',
                        'name' => 'Запчасти',
                        'loader' => array(
                            'serviceUrl' => '/local/components/sladcovich/alphaautob24.part/alphaautob24.part.ajax.php?&site' . SITE_ID . '&' . bitrix_sessid_get(),
                            'componentData' => array(
                                'template' => '',
								'params' => array(
									'ENTITY_ID' => array('UF_DEAL_ID' => $this->entityID),
									'TAB_ID' => 'tab_sladcovich_part',
								)
                            )
                        )
                    );

                    // sladcovich custom Запчасти СК
                    $this->arResult['TABS'][] = array(
                        'id' => 'tab_sladcovich_part_sk',
                        'name' => 'Запчасти СК',
                        'loader' => array(
                            'serviceUrl' => '/local/components/sladcovich/alphaautob24.partsk/alphaautob24.partsk.ajax.php?&site' . SITE_ID . '&' . bitrix_sessid_get(),
                            'componentData' => array(
                                'template' => '',
								'params' => array(
									'ENTITY_ID' => array('UF_DEAL_ID' => $this->entityID),
									'TAB_ID' => 'tab_sladcovich_part_sk',
								)
                            )
                        )
                    );

                    // sladcovich custom Себестоимость
                    $this->arResult['TABS'][] = array(
                        'id' => 'tab_sladcovich_cost_price',
                        'name' => 'Себестоимость',
                        'loader' => array(
                            'serviceUrl' => '/local/components/sladcovich/alphaautob24.costprice/alphaautob24.costprice.ajax.php?&site' . SITE_ID . '&' . bitrix_sessid_get(),
                            'componentData' => array(
                                'template' => '',
								'params' => array(
									'ENTITY_ID' => array('UF_DEAL_ID' => $this->entityID),
									'TAB_ID' => 'tab_sladcovich_cost_price',
								)
                            )
                        )
                    );
