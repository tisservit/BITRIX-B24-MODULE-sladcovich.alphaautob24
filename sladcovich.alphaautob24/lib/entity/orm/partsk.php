 ...
 */
class PartSKTable extends Entity\DataManager
{
    /**
    ...
    {
        return 'b_sladcovich_alphaautob24_entity_orm_part_sk';
    }
    ...
    public static function getMap()
    {
        return [
            ...
            new Entity\StringField('CATEGORY_NUMBER',   ['title' => 'Кат. №']),
            new Entity\StringField('NAME',              ['title' => 'Наименование']),
            new Entity\FloatField('PRICE',              ['title' => 'Цена']),
            new Entity\FloatField('COEFFICIENT',        ['title' => 'Коэффициент']),
